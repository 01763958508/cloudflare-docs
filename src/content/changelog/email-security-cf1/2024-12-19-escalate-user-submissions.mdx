...
After you triage your users' submissions, you can now escalate them to our team for reclassification (which are human reviewed). User submissions from the submission alias, PhishNet, and our API can all be escalated. 
